...
namespace Zeebe.Client.Bootstrap.Unit.Tests.Options
{
    public class ZeebeClientBootstrapOptionsValidatorTests
    {
        ...
        public Mock<ZeebeClientBootstrapOptions> zeebeClientBootstrapOptionsMock { get; }
        ...
        {
            new ZeebeClientBootstrapOptionsValidator().Validate(zeebeClientBootstrapOptionsMock.Object);
        }
        ...
        private static Mock<ZeebeClientBootstrapOptions> CreateZeebeClientBootstrapOptionsMock(Mock<ClientOptions> zeebeClientOptionsMock, Mock<WorkerOptions> workerOptionsMock)
        {
